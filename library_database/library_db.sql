...
\restrict G3TxRcDlLHeD07T61J2tOsJJe3e55FG9FnS07IqDTqwjEfNSLFAWkFvQ0P474MV
...
1	Cash	t	2026-06-24 04:57:03.723076	2026-06-24 04:57:03.723076
6	UPI	t	2026-06-26 22:00:40.571309	2026-06-26 22:00:40.571309
\.
...
SELECT pg_catalog.setval('public.fee_plans_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.payment_modes_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.student_shift_assignments_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.student_validities_id_seq', 1, true);
...
\unrestrict G3TxRcDlLHeD07T61J2tOsJJe3e55FG9FnS07IqDTqwjEfNSLFAWkFvQ0P474MV
